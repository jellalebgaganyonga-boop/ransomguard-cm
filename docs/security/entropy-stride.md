...
| Rule logic subversion via crafted input | Elevation | Low | Crafted entropy values to crash detector | Input validation + [0.0, 8.0] bounds check + property-based testing FsCheck | CWE-20 | SI-10 |
| Extension case sensitivity bypass | Spoofing | Low | ".DOCX" vs ".docx" bypasses susceptible list | ToLowerInvariant() on all extension checks | CWE-178 | SI-10 |
...
| Channel DropOldest discards real alerts | DoS | Medium | 10K+ events cause legitimate alerts to be dropped | Channel capacity 10K + pressure metric logging + alert persistence before enrichment | CWE-770 | SC-5 |
...
## Compliance Mapping
- CWE Top 25: CWE-20, CWE-22, CWE-178, CWE-345, CWE-367, CWE-400, CWE-532, CWE-674, CWE-770
